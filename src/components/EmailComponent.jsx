    ...
    <div>
        <div className="bg-black px-8 py-14 text-white mb-4 mx-1">
            ...
            <div className='mb-8 w-full mx-auto'>
                                ...
                                <div className="flex sm:flex-col flex-row lg:w-9/12 w-full ">
                                ...
                                <button onClick={onSubmit} type='submit' className='bg-blue-900 px-7 ml-3 rounded-md sm:w-full'>Subcribe</button>
